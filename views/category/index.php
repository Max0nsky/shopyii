            ...
            <div class="col-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <?php foreach ($categories as $category) : ?>
                        <a href="<?= Url::to(['/category/view', 'id' => $category['id']]) ?>" class="nav-link" id="v-pills-profile-tab" role="tab" aria-controls="v-pills-profile">
                            <?= $category['name'] ?>
                        </a>
                    <?php endforeach; ?>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 ml-auto mr-auto text-center">
                ...
                <span class="lead">Ян Климек</span>
            </div>
        </div>
    </div>
</div>
